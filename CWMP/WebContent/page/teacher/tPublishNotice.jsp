...
<html>
  ...
  <body class = "top" style="background: url(/CWMP/img/1.jpg);">
		...
		<div style="margin:0% 5% 0% 5%; ">
			...
			<!-- 操作区 -->
			<div class = "operation">
			<div style="height: 28px;"><a href="/CWMP/teacherServlet" >首 页</a></div>当前位置: 教师&gt;个人设置&gt;发布公告
					<form action="/CWMP/tPublishNoticeServlet" method = "post">
						<div class = "detail">
							 <select name = "NtCLno">
						...
						发布时间 :<br>
							<input name = "NtTime" type = "date" size = "30" class = "input_text" ><br><br><br>
							<input name= "NtTitle" type = "text" size = "20" class = "input_text" placeholder = "请输入主题!"><br><br>
							全  部 <input name = "all" type = "checkbox" value = "1"  style = "width:15px;height:15px;background:none;"><br><br>
						</div>
						<div class = "content">
							内 容:<br><textarea name = "NtContent" rows="15" cols="70" style = "background-color:#EBEBEB;"></textarea><br><br>
