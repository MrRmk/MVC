	...
	<head>
	    ...
	    <script type="text/javascript">
		    ...
		    var change=function(o){
		        //限制只数字
		        o.value=o.value.replace(/\D/g,'').substring(0,8);//长度限制，7是长度
		    };
	...
	<body class = "top" style="background: url(/CWMP/img/1.jpg);">
		...
		<div class = "total" style="margin:0% 5% 0% 5%; height: 680px;" >
			...
			<div class = "operation">
				...
				<form action="/CWMP/mAddStudentServlet" method="post">
					学 &nbsp;&nbsp;&nbsp;&nbsp;号: <input type="text" name="Sno" oninput="change(this)" onpropertychange="change(this)" class = "input_text" size = "20" placeholder="请输入8位数字！" />	<br><br>
					姓 &nbsp;&nbsp;&nbsp;&nbsp;名: <input type="text" name="Sname"  class = "input_text" size = "20" maxlength="12" placeholder="如：xxx" /><br><br>
					性 &nbsp;&nbsp;&nbsp;&nbsp;别: &nbsp;
					...
					密 &nbsp;&nbsp;&nbsp;&nbsp;码: <input type="text" name="Spassword"  class = "input_text" size = "20" maxlength="6" placeholder="请输入6位字母,数字！" /><br><br>
					系 &nbsp;&nbsp;&nbsp;&nbsp;别: <input type="text" name="Sdept"  class = "input_text" size = "20" maxlength="12" placeholder="如：软件学院" /><br><br>
					班 &nbsp;&nbsp;&nbsp;&nbsp;级: <input type="text" name="CLno"  class = "input_text" size = "20" maxlength="6" placeholder="请输入6位数字！" /><br><br><br/>
